...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <form action="<?= base_url('/kendaraan/motor/riwayat/tambah/' . $kendaraan['id']) ?>" method="post">
        <div class="row">
            <div class="col-md-3 mb-3">
                <label for="nomor_polisi" class="form-label">Nomor Polisi</label>
                <input type="text" name="nomor_polisi" id="nomor_polisi" class="form-control" value="<?= esc($kendaraan['no_polisi'] ?? '') ?>" required>
            </div>
        ...
        <div class="d-flex justify-content-start gap-2 mt-3">
            ...
            <a href="<?= base_url('/kendaraan/motor') ?>" class="btn btn-secondary">Kembali</a>
        </div>
    </form>
</div>
